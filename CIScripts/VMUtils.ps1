...
function New-TestbedVMs {
    ...
    function Install-Artifacts {
        ...
        Copy-Item -ToSession $Session -Path "docker_driver\DockerDriver.msi" -Destination C:\Artifacts\
        ...
        Invoke-Command -Session $Session -ScriptBlock {
            ...
            Start-Process msiexec.exe -ArgumentList @("/i", "C:\Artifacts\DockerDriver.msi", "/quiet") -Wait
